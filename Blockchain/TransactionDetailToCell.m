...
- (void)configureWithTransactionModel:(TransactionDetailViewModel *)transactionModel
{
    ...
    if (transactionModel.to.count > 1) {
        ...
        self.accessoryLabel.text = transactionModel.isContactTransaction && [transactionModel.txType isEqualToString:TX_TYPE_SENT] ? transactionModel.contactName : [transactionModel.to.firstObject objectForKey:DICTIONARY_KEY_LABEL];
