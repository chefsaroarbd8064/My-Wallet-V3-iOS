...
- (void)reloadCards
{
    ...
    self.scrollView.contentSize = CGSizeMake(self.view.frame.size.width, self.contentView.frame.size.height + (self.showBuyAvailableNow || self.showCards ? self.cardsViewHeight : 0));
}
